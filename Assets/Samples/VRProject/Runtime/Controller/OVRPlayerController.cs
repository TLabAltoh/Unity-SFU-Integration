...
namespace TLab.VRProjct
{
    public class OVRPlayerController : BasePlayerController
    {
        ...
        protected override void Update()
        {
            ...
            var targetForward = new Vector3(m_cameraAnchor.forward.x, ZERO, m_cameraAnchor.forward.z).normalized;
            var targetRight = new Vector3(m_cameraAnchor.right.x, ZERO, m_cameraAnchor.right.z).normalized;
